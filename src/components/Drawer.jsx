            ...
            <section className={`w-56 phone:w-64 h-full flex flex-col ${getBackgroundColor(theme)} ${getOppositeTextColor(theme)}`}>
                ...
                <section className="py-6">
                    <ul className={`list-none text-base ${getTextColor(theme)}`}>
                        ...
                        <li onClick={() => toggleModal(setThemeModal)} className={`px-4 py-2 flex items-center gap-2 text-start ${getTextColor(theme)} ${getHoverTextHighlightColor(theme)} cursor-pointer`}>
