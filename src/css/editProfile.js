import {getBackgroundColor, getDisabledBgNeutral30Color, getTextPrimaryColor, getTextHighlightColor, getTextErrorColor, getBorderNeutralColor, getFocusBorderPrimaryColor, getFocusBorderHighlightColor, getBorderErrorColor, getOutlinePrimaryColor, getOutlineTextColor, getOutlineErrorColor} from './color';
...
export default function(theme) {
    return {
        ...
        otp: `!w-7 phone:!w-8 phone:!h-10 desktop:!w-10 desktop:!h-12 text-2xl ${getBackgroundColor(theme)} border ${getBorderNeutralColor(theme)} ${theme === 'dark' ? getOutlineTextColor(theme) : getOutlinePrimaryColor(theme)} rounded-md ${getDisabledBgNeutral30Color(theme)} disabled:cursor-not-allowed`,
