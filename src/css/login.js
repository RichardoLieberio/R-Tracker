export default {
    ...
    defaultInput: 'w-full px-3 py-2 text-base text-purple-text border border-purple-neutral rounded-md outline-none focus:border-purple-primary disabled:bg-purple-neutral/30 disabled:cursor-not-allowed',
    defaultInputError: 'w-full px-3 py-2 pl-10 text-base text-purple-text border border-purple-error rounded-md outline-none',
    pwdInput: 'w-full px-3 py-2 pr-10 text-base text-purple-text border border-purple-neutral rounded-md outline-none focus:border-purple-primary disabled:bg-purple-neutral/30 disabled:cursor-not-allowed',
