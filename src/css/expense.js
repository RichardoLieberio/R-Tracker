...
export default function(theme) {
    return {
        ...
        nonFocusInput: `w-full px-3 py-2 ${getBackgroundColor(theme)} border ${getBorderNeutralColor(theme)} rounded-md outline-none ${getDisabledBgNeutral30Color(theme)} disabled:cursor-not-allowed`,
